      ...
      <ScrollView>
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Imc: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Grasa: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Musculo: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Basal: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Agua: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Osea: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
        ...
        <View style={styles.action}>
          <Input
            ...
            onChangeText={(text) => setEvalInfo({ ...EvalInfo, Viseral: text })}
            autoCorrect={false}
            keyboardType="number-pad"
            returnKeyType="done"
          />
